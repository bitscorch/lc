...
//! Easy | Dynamic Programming | Bit Manipulation | Enumeration
...
//! **Explanation:**
//!
//! There are no compatible integers in the range `[4, 6]`. Thus, the answer is
//! 0.
//!
//! **Constraints:**
//!
...
impl Solution {
    pub fn sum_of_good_integers(n: i32, k: i32) -> i32 {
        (1.max(n - k)..=(n + k)).filter(|x| n & x == 0).sum()
    }
}
